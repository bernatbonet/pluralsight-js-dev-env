/* This file references to the vendor libraries
   we're using in this project. This is used by webpack
   in the production build only. A separate bundler for vendor
   code is useful since it's unlikely to change often
